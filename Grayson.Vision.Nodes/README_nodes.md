  ...
  namespace Grayson.Vision.Contracts.Flow.Enums
{
    ...
    public enum NodeType
    {
        ...
        // ==========================================
        [NodeFieldMeta("📸", "#00A896", "相机采集", "相机采集 (支持硬件触发/软触发/离线文件)")]
        AcquireImage,       // 海康/大恒/巴斯勒 SDK 或离线图片/序列读取

        [NodeFieldMeta("🎛️", "#05668D", "通道拆分", "RGB/HSV 通道拆分与合成")]
        ImageChannel,       // RGB/HSV 通道拆分或多灰度图合成
